...
echo =======================================================
echo Llama-CPP-Python Auto-Installer (Windows Direct Links)
echo =======================================================
echo.
...
:: 4. EXECUTE SCRIPT AND SAVE OUTPUT TO TEXT FILE (Bypasses CMD quote bugs)
...
echo [INFO] Match found! Downloading and installing:
echo %TARGET_WHEEL%
echo.


:: 7. EXECUTE INSTALLATION
"%PYTHON_EXE%" -m pip install "%TARGET_WHEEL%"
